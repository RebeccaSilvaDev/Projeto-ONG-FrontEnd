console.log("-> 3. ARQUIVO KPIS-MANAGER.JS FOI EXECUTADO.");
...
// --------------------------------------------------------------
// I. MÓDULO: INDEX (Animação de Borda Azul Única nas Conquistas)
// --------------------------------------------------------------
...
function inicializarKpisProjetos() {
...
/* =============================================================== */
/* ARQUIVO: js/relatorio-anual-kpis.js                             */
/* Funções de animação de KPIs para a página relatorio-anual.html  */
/* =============================================================== */

function inicializarKpisRelatorio() {
  // -----------------------------------------------------------------
  // 1. DADOS FINANCEIROS
